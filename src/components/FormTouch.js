    ...
    <form className="w-full sm:w-1/2  space-y-3">
      <div class="relative">
        <input
          ...
          class="block px-2 pb-2 pt-2 w-full text-sm text-gray-900 bg-transparent rounded-lg border-[1px] border-gray-950 appearance-none dark:text-white dark:border-neutral-200 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
          placeholder=" "
        />
        <label
      ...
      <button class=" px-20 py-2 bg-blue-500 text-blue-100 hover:bg-blue-600 duration-300">
        Submit
      </button>
    </form>
  );
